...
%---------------------------------------------------------
	...
	%---------------------------------------------------------
	\begin{frame}{Comparación con hipótesis alternativas}
		...
		\begin{table}
			...
			\resizebox{0.9\linewidth}{!}{
				\begin{tabular}{lcc}
					...
					$\alpha$ óptimo & \cellcolor{yellow!40}$1.8999 \pm 0.0222$ & $2.5158 \pm 0.0479$ \\
					KS óptima & 0,0139 & 0,0608 \\
					$n_{\text{cola}}$ & 1646 (24,3\%) & 1001 (22,0\%) \\
					p-valor & \cellcolor{green!40}0,532 & \cellcolor{red!40}0,000 \\
					\hline
					Interpretación & No rechazada ($p > 0.1$) & Rechazada ($p \le 0.1$) \\
					\hline
				\end{tabular}
			}
	...
	\begin{frame}{Comparación con alternativas}
		\begin{table}
			...
			\resizebox{\linewidth}{!}{
				\begin{tabular}{lccl}
					\hline
					\textbf{Distribución Alternativa} & $\mathcal{R}$ & \textbf{p-valor} & \textbf{Interpretación} \\
					\hline
					\multicolumn{4}{c}{\textbf{Grado de Entrada} \quad ($k_{\min}=3, \alpha=1.900, p_{\text{KS}}=0.532$)} \\
					\hline
					Exponencial & $8.432$ & \cellcolor{green!40}$<0.001$ & Ley de potencias favorable \\
					Poisson     & $5.401$ & \cellcolor{green!40}$<0.001$ & Ley de potencias favorable \\
					Yule        & $-1.598$ & \cellcolor{yellow!40}$0.110$ & No distinguibles \\
					\hline
					\multicolumn{4}{c}{\textbf{Grado de Salida} \quad ($k_{\min}=11, \alpha=2.516, p_{\text{KS}}<0.001$)} \\
					\hline
					Exponencial & $1.307$ & \cellcolor{yellow!40}$0.191$ & No distinguibles \\
					Poisson     & $3.824$ & \cellcolor{green!40}$<0.001$ & Ley de potencias favorable \\
					Yule        & $-8.943$ & \cellcolor{red!40}$<0.001$ & Alternativa favorable \\
					\hline
				\end{tabular}
			}
