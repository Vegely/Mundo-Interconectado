...
\begin{longtblr}[
	caption = {Descripción de las comunidades...},
	label   = {tab:communities_desc},
	remark{Note} = {Continúa en la siguiente página...},
	]{
		colspec  = {|c|c|X|},
		rowsep   = 4pt,
		hlines,
	...
	\SetCell{bg={rgb,255:red,59;green,137;blue,235}}  16 & 4    & Comunidad mínima formada por \texttt{Pyro4} y sus dependencias directas (\texttt{serpent}, \texttt{selectors34}), que implementan un sistema de objetos remotos (\textit{Remote Object System}) para Python, permitiendo la comunicación transparente entre procesos distribuidos. \\
